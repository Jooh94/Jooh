/* 
	함수 : 미리정의된 코드
		...
		function 함수명 ( 매개변수 ~ ){ 정의코드  return 리턴값}
	...
	2. 선언적함수 : 일반 함수
		function 함수명() { }
	3. 나머지매개변수 : 매개변수의 고정적이지 않는 함수 -> 배열
	...
	5. 콜백함수 : 함수도 자료형이기 때문에 매개변수로 전달이 가능하다.
		...
		* 미리 만들어진 콜백 형태이 함수들
			forEach() : 반복문
			map()	  : 새로운 배열 생성 [return 값을 새로운 배열저장]
			filiter() : 새로운 배열 생성 [return ture인 경우에만 값을 새로운 배열 저장]
