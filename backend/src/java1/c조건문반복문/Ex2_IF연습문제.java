...
public class Ex2_IF연습문제 {
	...
	public static void main(String[] args) {
		...
		System.out.print("문제1)정수2 입력:"); int 문제1_2 = scanner.nextInt();
		...
		System.out.print("문제1)정수1 입력:"); int 문제2_1 = scanner.nextInt();
		System.out.print("문제1)정수2 입력:"); int 문제2_2 = scanner.nextInt();
		System.out.print("문제1)정수3 입력:"); int 문제2_3 = scanner.nextInt();
		...
		*/
		...
		// 문제3 : 3개의 정수를 입력받아서 오름차순 / 내림차순  [경우의수 : 3 7 5]
		System.out.print("문제1)정수1 입력:"); int 문제3_1 = scanner.nextInt();
		System.out.print("문제1)정수2 입력:"); int 문제3_2 = scanner.nextInt();
		System.out.print("문제1)정수3 입력:"); int 문제3_3 = scanner.nextInt();	
		...
		System.out.println( 문제3_1 + " "+문제3_2+" "+문제3_3); //출력방식
		...
		//문제5
			...
			//				그외 재시험
		/*
		System.out.println("문제5)점수입력"); int  문제5= scanner.nextInt();
		...
		*/
		 ...
		 */
		/*
		System.out.println("문제5) 국어 입력:"); int 국어 =scanner.nextInt();
		System.out.println("문제5) 영어 입력:"); int 영어 =scanner.nextInt();
		System.out.println("문제5) 수학 입력:"); int 수학 =scanner.nextInt();
		...
		*/
		...
		//문제7 로그인페이지
			...
			//if( 아이디 == "admin") { // 아이디가 admin 이면
					// 비교 연산자는 기본자료형(int,char,double)비교연산자 가능 ---> 비교 메소드(함수)
