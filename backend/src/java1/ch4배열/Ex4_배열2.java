...
public static void main(String[] args) { // main s
				...
				String[ ] 배열1 = new String[10]; //String 객체를 10개 저장할수 있는 배열
					...
					//2. 항목에 값 수정
					배열1[0] = "하하";
					//3. 항목에 값 삭제 [메모리 자체삭제 X ->데이터 초기화]
					배열1[1] = null; 
					// 4. 모든 항목 호출
					for ( String value : 배열1) {System.out.println(value);}
				//2차원 배열 [가로=row] [ 세로=col ]
				String[ ][ ] 배열2 = new String[10][2];  // String 객체를 20개 저장할수있는 배열
					//2. 항목에 값 대입
					배열2[0][0] ="유재석"; 	배열2[0][1] = "010-4444-4444";
					배열2[1][0] ="강호동"; 	배열2[1][1] = "010-2222-4444";
					배열2[2][0] ="신동엽"; 	배열2[2][1] = "010-3333-4444";
					// 2. 항목에 값 수정
